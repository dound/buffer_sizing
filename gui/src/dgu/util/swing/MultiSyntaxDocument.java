...
//Rev Date: $Date: 2007/02/20 13:59:38 $
 ...
 *
 * @author camickr (java sun forums user)
...
public class MultiSyntaxDocument extends DefaultStyledDocument
{
     ...
     */
    protected void setAttributeStyle( ATTR_TYPE attr, MutableAttributeSet style ) {
        if(      attr == ATTR_TYPE.Comment ) comment = style;
        else if( attr == ATTR_TYPE.Quote   ) quote = style;
        else                                 normal = style;
    }
