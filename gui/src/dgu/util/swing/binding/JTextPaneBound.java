//Filename: JTextPaneBound.java
//Revision: $Revision: 1.1 $
//Rev Date: $Date: 2007/02/20 15:25:22 $
//Author's Note: identical to JTextArea except all occurrences of JTextArea are replaced with JTextPane
 ...
 */
public class JTextPaneBound<FROM> extends JTextPane implements BoundComponent {
     ...
     */
    public JTextPaneBound( TypeTranslator<FROM, String> translator, String varName ) {
        super();
     ...
     *                     (ex: if varName is "value" then the getter will be getValue).
     */
    public JTextPaneBound( TypeTranslator<FROM, String> translator, Object boundItem, String varName ) {
        super();
     ...
     */
    public JTextPaneBound( TypeTranslator<FROM, String> translator, Object boundItem, String getterName, String setterName ) {
        super();
     ...
     */
    public JTextPaneBound( TypeTranslator<FROM, String> translator, Object boundItem, String getterName, String setterName, int indexAt ) {
        super();
     ...
     *                     (ex: if varName is "value" then the getter will be getValue).
     */
    public JTextPaneBound( String varName ) {
        super();
     ...
     *                     (ex: if varName is "value" then the getter will be getValue).
     */
    public JTextPaneBound( Object boundItem, String varName ) {
        super();
        delegate = (JTextComponentDelegate<FROM>)new JTextComponentDelegate<String>( 
     ...
     * @param  setterName  how to set the bound value from the bound object
     */
    public JTextPaneBound( Object boundItem, String getterName, String setterName ) {
        super();
        delegate = (JTextComponentDelegate<FROM>)new JTextComponentDelegate<String>( 
     ...
     *                     use; otherwise, indexAt should be -1
     */
    public JTextPaneBound( Object boundItem, String getterName, String setterName, int indexAt ) {
        super();
        delegate = (JTextComponentDelegate<FROM>)new JTextComponentDelegate<String>( 
